...
def loginhome(username):
    ...
    with st.container():
        ...
        with st.container():  # Navigation bar at the top
            menu_data = [
                {'id': 'Most Watched Movies', 'icon': "far fa-copy", 'label': "Most Watched Movies",
                 'ttip': "Most Watched Movies"},  # Most Watched Movies
                {'id': 'Category', 'icon': "bi bi-bookmarks-fill", 'label': "Category", 'ttip': "Category"},  # Category
                {'id': 'Upcoming_Movie', 'icon': "bi bi-film", 'label': "Upcoming_Movies", 'ttip': "Upcoming Movie"},
                # Upcoming Movie
                {'id': 'About Us', 'icon': "bi bi-people-fill", 'label': "About Us", 'ttip': "About Us"},  # About Us
                {'id': 'Contact Us', 'icon': "bi bi-telephone", 'label': "Contact Us", 'ttip': "Contact Us"},
                # Contact Us
